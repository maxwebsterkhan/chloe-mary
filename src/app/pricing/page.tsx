              ...
              <div className={styles.destinationMatrix}>
                ...
                >
                  ...
                  <div className={styles.destinationDetails}>
                    <span className={styles.destinationPrice}>From £4,250</span>
                ...
                >
                  ...
                  <div className={styles.destinationDetails}>
                    <span className={styles.destinationPrice}>From £4,750</span>
                    <span className={styles.destinationDesc}>
                      9 hours of documentation
                    </span>
                  </div>
              ...
              <div className={styles.inclusionsList}>
                <div className={`${styles.inclusionRow} ${styles.animateIn}`}>
                  ...
                  <div className={styles.inclusionDesc}>
                    You will receive a preview gallery within 1-2 weeks of your
                    wedding date with the remaining images delivered in your
                    final gallery within 12 weeks. This includes unlimited
                    downloads for you, your family and friends and remains
                    online for 6 months.
                  </div>
                </div>
                ...
                <div className={`${styles.inclusionRow} ${styles.animateIn}`}>
                  ...
                  <div className={styles.inclusionDesc}>
                    ...
                    printing licence which allows you to print your photos with
                ...
                <div className={`${styles.inclusionRow} ${styles.animateIn}`}>
                  ...
                  <div className={styles.inclusionDesc}>
                    All UK travel is included within quoted fees. For Scotland,
                    Ireland and destination weddings, additional charges will
                    apply but are clearly outlined in your quote.
                  </div>
                </div>
                ...
                <div className={`${styles.inclusionRow} ${styles.animateIn}`}>
                  ...
                  <div className={styles.inclusionDesc}>
                    ...
                    professional quality products. With a wide range of choices
                    and products delivered straight to your door, this is an
                    easy and convenient way to order quality and trusted
                    products.
                  </div>
                </div>
                ...
                <div className={`${styles.inclusionRow} ${styles.animateIn}`}>
                  ...
                  <div className={styles.inclusionDesc}>
                    Wedding planning for some can be a stressful experience, so
                    having an inside source of knowledge available to you
                    whenever needed can be invaluable. I personally allocate
                    time in my schedule to be available for you whenever needed
                    and you can ask me any questions or for advice, no matter
                    how big or small.
                  </div>
                </div>

                <div className={`${styles.inclusionRow} ${styles.animateIn}`}>
                  <div className={styles.inclusionLabel}>LITTLE BLACK BOOK</div>
                  <div className={styles.inclusionDesc}>
                    As part of booking with me, you&apos;ll receive exclusive
                    access to my &apos;little black book&apos; which is full of
                    supplier recommendations to help you with planning.
